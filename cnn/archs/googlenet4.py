...
""" Modified ResNet for 4 channels
Original file from https://raw.githubusercontent.com/pytorch/vision/main/torchvision/models/googlenet.py
...
class GoogLeNet(nn.Module):
    ...
    def __init__(
        ...
        # 3 to 1
        self.conv1 = conv_block(4, 64, kernel_size=7, stride=2, padding=3)
